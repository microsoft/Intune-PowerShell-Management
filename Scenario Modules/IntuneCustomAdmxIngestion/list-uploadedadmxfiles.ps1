...
param
(
    [Parameter(Mandatory = $false, HelpMessage = "File Id to get more info about it")]
    $FileId = $null,
...
if ($FileId -eq $null){
	...
	$DCP_resource = "deviceManagement/groupPolicyUploadedDefinitionFiles('$FileId')?`$expand=groupPolicyOperations"
	$uri = "$serviceEndpoint/$($DCP_resource)"
	echo $uri
	echo $authToken
        $getResult = (Invoke-RestMethod -Uri $uri -Headers $authToken -Method Get)
	$getResult
	echo "Languages"
	$getResult.groupPolicyUploadedLanguageFiles | fl
	echo "Operations"
	$getResult.groupPolicyOperations | fl 
}
...
List-ADMXFile $FileId $serviceEndpoint

# SIG # Begin signature block
# MIIjhwYJKoZIhvcNAQcCoIIjeDCCI3QCAQExDzANBglghkgBZQMEAgEFADB5Bgor
# BgEEAYI3AgEEoGswaTA0BgorBgEEAYI3AgEeMCYCAwEAAAQQH8w7YFlLCE63JNLG
# KX7zUQIBAAIBAAIBAAIBAAIBADAxMA0GCWCGSAFlAwQCAQUABCDfmzhkOsBXWIN7
# DTuwGmBgmGZyBV8NwmPq2aKqze7WBKCCDXYwggX0MIID3KADAgECAhMzAAAB3vl+
...
# MAwGCisGAQQBgjcCARUwLwYJKoZIhvcNAQkEMSIEIKWSFe1ZWOnCmIrNid1iQ2/J
# jkQBqPGyp5rPoO5s22x3MEIGCisGAQQBgjcCAQwxNDAyoBSAEgBNAGkAYwByAG8A
# cwBvAGYAdKEagBhodHRwOi8vd3d3Lm1pY3Jvc29mdC5jb20wDQYJKoZIhvcNAQEB
# BQAEggEAp+eTj86vKcXTl9sgoV5OPJwlWLAmwFfmnTknSdkkmiAemFoWvlk02vdQ
# 4Fy9SgoRNe4ojqU45hvTvb+gLu95Pb2VwZV1c9+7bJxBOtFeI8S1ZEChplHB1916
# 5/fMeytGieiWrT9VOTr2jYRqwxYowEhvbfndxLHF7SrCIx4vRoVq+gSoaS1NiPW/
# 6pWEhwZBgM6PxP1uos4obl7hEh6cGj8IeYb3rKSB1xl11v70WC0BgzwQYqUe3lac
# Xq2wpQ28AsEp6BSyk7S02ggKKGWPOHtDmoHdHz2bSSkXIiIbk9C2PxIWHGhQ0XCz
# 2055DXge8sfxUxuyVyWxr7gWjQ8IUqGCEvEwghLtBgorBgEEAYI3AwMBMYIS3TCC
...
# AwQCAQUABCDA6gaWAcGS3qjkE4SLetIT1CQsLH6r8YvPlSHuC9BLxQIGYNOi0BKs
# GBMyMDIxMDcyMDE4MTczOS42NThaMASAAgH0oIHUpIHRMIHOMQswCQYDVQQGEwJV
...
# BgkqhkiG9w0BCQMxDQYLKoZIhvcNAQkQAQQwLwYJKoZIhvcNAQkEMSIEIOCQdyEg
# lbA1ql4oI882t5aHGo7GTT5c4Mt4i2JyC3j0MIH6BgsqhkiG9w0BCRACLzGB6jCB
...
# 9w0BAQsFAASCAQAh24fm924VPiBt/LLZcd38ifKNR42eRp/zKjLekyJlDexCmjUT
# 0vuKGTKBaC3McnLN91NeC8qPnZCn/ENyyTor7dwEqxhLBx8yYPmGn1bh4N0rQ66+
# SnHiT/jPyC+KN9YHnyHPY/WwDfCW1mR36iDaujiDQkQuAJcVPItph5k3MFWfNwoH
# FeIpS7he4Ug0V+t9nthdBh4jLzIF47U4bEvyQCYlWvuvngY8NjKano59cOHrzJXz
# xEB5BQY6bt3TmIiO9YIhwGzPe2PbANmG7gB64IPIxs63W/wMSduAMuUpmr26/Hvn
# Gg7F8IY5jW8B9MQX79lSIpcxJzPcv+BMlEEU
