...
.PARAMETER GPOBackupFolderPath
    The folder path on local disk where GPO Reports exported from Domain are saved.
.EXAMPLE 
    .\Import-GPOBackupReports.ps1 -TenantAdminUPN "admin@IPASHAMSUA01MSIT.onmicrosoft.com" -GPOBackupFolderPath "C:\GPOBackup"
#>
param(
    ...
    [Parameter(Mandatory=$true)]
    [Alias("GPOBackupFolderPath")]
    [String]$script:GpoBackupFolderPath = $null,
    [Alias("Environment")]
    # Environment is relevant only for test environments
    [String]$script:Environment = "dogfood"    
)
...
# Import dependencies
Import-Module "$script:PSScriptRoot\IntunePolicyAnalyticsClient.psd1"

Try
{   
    If (Test-Path -Path $script:GpoBackupFolderPath)
    {
        # Import GPOs from GpoBackupFolderPath
        $importedGPOCollection = Import-GPOCollection -TenantAdminUPN $script:TenantAdminUPN -GpoBackupFolderPath $script:GpoBackupFolderPath -Environment $script:Environment        
    }
    Else 
    {
        Write-Error -Message "Import-GPOBackupReports failed. $($script:GpoBackupFolderPath) does not exist."
        throw
    }

    return $importedGPOCollection
}
Catch
{
    $exception = $_
    Write-Host "Import-GPOBackupReports failed. Error = $($exception)"
    throw
}
Finally 
{
    Remove-Module -Name "IntunePolicyAnalyticsClient"
}
...
# KX7zUQIBAAIBAAIBAAIBAAIBADAxMA0GCWCGSAFlAwQCAQUABCDWRA/AxehMRRsv
# OkA0pCJ9JB6mUfsJltVePn8oeFWRLKCCDYEwggX/MIID56ADAgECAhMzAAAB32vw
...
# BgEEAYI3AgELMQ4wDAYKKwYBBAGCNwIBFTAvBgkqhkiG9w0BCQQxIgQggK7vCx92
# j3jNrm4RWUPKQmEgAiMeJZs1iiH/PniSpMMwQgYKKwYBBAGCNwIBDDE0MDKgFIAS
# AE0AaQBjAHIAbwBzAG8AZgB0oRqAGGh0dHA6Ly93d3cubWljcm9zb2Z0LmNvbTAN
# BgkqhkiG9w0BAQEFAASCAQA3/0NYPJTc4yr99sULcZFAHIP7hjahj1mhal6083U5
# KYYeUiJqabD7KRuzSJbgolbE0Gbmlz5jATktRweESh8SkT6SS11ygxLMyqDt/25L
# wnQ6sQi/ZbbIdo6+sJM6YKQmEQGRP5lJrXiuUIxR8oQLemhjVSYjNCuVXpiOQjOc
# 1EhXtaRfhsUYolKBsgBn1POlkD1ClsXy1v8FU/6mjOCgOIoQMBbcvW30AtziFu4Y
# atSOxgU2cVli+Y1ZsQ9JiS6k9v1x53LcOUh71/ZAkyAygtmwrRuK5zYvhEVAQwNZ
# sCA1VzqRKj7Q0OWUuuPT289q2MSvNMtvrH3FP305BygIoYIS8TCCEu0GCisGAQQB
# gjcDAwExghLdMIIS2QYJKoZIhvcNAQcCoIISyjCCEsYCAQMxDzANBglghkgBZQME
# AgEFADCCAVUGCyqGSIb3DQEJEAEEoIIBRASCAUAwggE8AgEBBgorBgEEAYRZCgMB
# MDEwDQYJYIZIAWUDBAIBBQAEIBtw7Efb+PZgWyBJ95yYJERW69D2/Yy976j4plXU
# nPJMAgZgr7WGZgsYEzIwMjEwNjE4MDY1NTMxLjk3M1owBIACAfSggdSkgdEwgc4x
...
# CQQxIgQg5UyWGsdfTMoTuKIKh1P3q8HN5ytjdT2F/3KFcU2IxQ8wgfoGCyqGSIb3
...
# +F7KMA0GCSqGSIb3DQEBCwUABIIBAAI9eu6SQf2HgV0LLQzGPg3Ti250CDO51BPC
# H2XFBeQlkoiI1PXZhT3pUb5418vnKvN/+iooKQP6n63FS5M/tSfttfMMowtzxIKm
# HdRsG/SKbmdD46sd3M7p2SetEG9744ooFpOjyHtEytYGP7u5PBxY4jhsAUu5gm0G
# jUPU+0KM24aZ5zaxETMBIQjPn/I97Q/WogxD0LmmNF9m7Jh3FYRapPYkPt0sJLsz
# WETbBqHBYbyQvgC3FbUAVjAvuSagzMDXB88/NrnPwEsjdVmznz46BgU7nK6LFo6/
# m4yNN8DJc3yCgLCQSEOZlf66hwhMoswC3iLJk5vVjRMXPq4rAus=
